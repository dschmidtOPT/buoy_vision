...
stream_uri="rtsp://service:Bosch123!@172.31.0.8:554?line=1&inst=1"
video_cap = cv2.VideoCapture(stream_uri, cv2.CAP_FFMPEG)
...
while success:
    ...
    #fps = "FPS: %d:.2f" % (1 / (end - start).total_seconds())
